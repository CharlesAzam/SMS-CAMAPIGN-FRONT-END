...
export class PackageWiseRevenueReport implements OnInit {
  ...
  filter: SupportFilter = { type: "REVENUE_PACKAGE_WISE" };
  ...
  ngOnInit() {
    this.filter = { type: "REVENUE_PACKAGE_WISE" };
